...
const trustBadges = [
  ...
  },
  {
    ...
    description: 'Understand return and cash flow',
    icon: TrendingUp,
  },
  {
    title: 'Built for South Africa',
    description: 'Local property investment assumptions',
    icon: MapPinned,
  },
]
...
const faqs = [
  {
    ...
    answer:
      'Rental yield shows rental income as a percentage of the property purchase price, helping investors compare return potential.',
  },
  {
    question: 'What is the difference between gross yield and net yield?',
    answer:
      'Gross yield uses rental income before costs. Net yield factors in vacancy allowance and operating expenses for a more realistic view.',
  },
  {
    question: 'What is a good rental yield in South Africa?',
    answer:
      'It depends on area, property type and strategy. Many investors compare yields alongside vacancy risk, tenant demand and capital growth potential.',
  },
  {
    question: 'Should I include levies and rates?',
    answer:
      'Yes. Levies, rates, insurance, management fees and maintenance allowances can materially affect net yield and monthly cash flow.',
  },
  {
    question: 'How does bond finance affect rental cash flow?',
    answer:
      'Bond finance adds a monthly repayment. A property can have a reasonable net yield but still need a monthly top-up after debt service.',
  },
]
      ...
      <main>
          ...
          <div className="mx-auto grid w-full max-w-[1340px] gap-9 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
            <div className="lg:sticky lg:top-32">
              <nav className="flex flex-wrap items-center gap-2 text-xs font-extrabold text-[#667085]" aria-label="Breadcrumb">
                ...
                <span className="text-[#98A2B3]">&gt;</span>
                <span className="text-[#101828]">Rental Yield Calculator</span>
              </nav>
              ...
              <p className="mt-6 max-w-[670px] text-lg font-medium leading-8 text-[#344054]">
                Estimate gross yield, net yield and monthly cash flow based on purchase price, rental income and property expenses.
              </p>
              ...
              <div className="mt-5 rounded-[18px] border border-[#0D4F45]/12 bg-[#EEF7F2] p-5">
                ...
                <p className="mt-2 text-sm font-semibold leading-6 text-[#344054]">
                  Rental yield calculations are estimates only and do not guarantee investment performance. Final returns may vary based on vacancies, maintenance, levies, rates, tax and financing terms.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto w-full max-w-[1340px]">
            <div className="mb-7 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-[520px] text-sm font-medium leading-6 text-[#667085]">
                Compare return, cash flow and finance assumptions before committing capital.
              </p>
            </div>
        ...
        <section className="px-5 pb-14 md:px-8 md:pb-20">
          <div className="mx-auto grid w-full max-w-[1340px] gap-6 rounded-[28px] bg-[#071E1A] p-7 text-white shadow-[0_26px_80px_rgba(7,30,26,0.18)] md:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-extrabold tracking-[-0.035em]">Need help comparing investment properties?</h2>
                <p className="mt-2 max-w-[740px] text-sm font-medium leading-7 text-white/70">
                  Arch9 can help you compare rental return, cash flow and long-term property potential in one connected workspace.
                </p>
              </div>
            </div>
        ...
        <section className="px-5 pb-16 md:px-8 md:pb-24">
          <div className="mx-auto w-full max-w-[1040px]">
            ...
            <h2 className="mt-3 text-[2.2rem] font-extrabold tracking-[-0.045em] text-[#101828]">Rental yield questions</h2>
